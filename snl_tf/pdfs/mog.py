...
import snl_tf.util.math as umath

from snl_tf.pdfs.gaussian import Gaussian
...
class MoG:
    ...
    def gen(self, n_samples=None, return_comps=False, rng=np.random):
        ...
        if n_samples is None:
            ...
            i = umath.discrete_sample(self.a, rng=rng)
            ...
            ii = umath.discrete_sample(self.a, n_samples, rng)
    ...
    def grad_log_p(self, x):
        ...
        ws = umath.softmax(ps.T + np.log(self.a)).T
